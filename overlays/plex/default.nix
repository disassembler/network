{ stdenv, fetchurl, rpmextract, glibc, coreutils
...
let
  ...
  plexpkg = if enablePlexPass then plexPass else {
    version = "1.20.4.3517";
    vsnHash = "ab5e1197c";
    sha256 = "8ee806f3fffedcecd0cab028bbe1f7e2ac7de24292b715978d3165c4712f5c40";
  };
...
in stdenv.mkDerivation rec {
  ...
  buildInputs = [ rpmextract glibc coreutils ];
